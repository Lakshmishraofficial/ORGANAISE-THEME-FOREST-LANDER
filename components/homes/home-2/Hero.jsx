...
export default function Hero() {
  return (
    <div id="hero_header" className="hero-header section panel overflow-hidden">
      <div className="section-outer panel py-6 xl:py-9 pt-9 lg:pt-10 dark:bg-gray-900">
        <div
                ...
                >
                  <div className="panel overflow-hidden">
                    <Image
                      ...
                      alt="Main hero image"
                      src="/assets/images/template/hero-two.webp"
                      width="1280"
                      height="941"
                    />
                    <Image
                      ...
                      alt="Main hero image"
                      src="/assets/images/template/hero-two-dark.webp"
                      width="1280"
                      height="942"
                    />
                  </div>
